...
<hr>
<a class="w3-button w3-blue w3-padding-large w3-hover-black" onclick="popup(1)">Přidat díl</a>
...
<div class="w3-white w3-container w3-padding-32" style="margin-top:75px;padding-right:58px"></div>
  ...
  <div id="id1" class="w3-modal">
    <div class="w3-modal-content w3-animate-zoom">
      ...
      <?php
      echo '<h2>Přidat díl</h2>';
      echo '<form action="new_part.php" method="post">';
      echo '<input class="input w3-border" type="text" name="thedata" value="" placeholder="Název dílu" required>';
      echo '<br><br>';
      echo '<input class="input w3-border" type="text" name="price" value="" placeholder="Cena v Kč" required>';
      echo '<br><br><button type="submit" id="submitBT" class="w3-button w3-blue w3-padding-small">Přidat</button>';
      echo '</form><br>';
      ?>
      </div>
    </div>
